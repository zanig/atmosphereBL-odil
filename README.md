...
Stable Boundary Layer w/ ODIL/B-ODIL attempt. It follows the GABLS weakly stable (0.05 K/h) and moderately stable (0.25 K/h) cases trying to reproduce the results from [this paper](https://doi.org/10.1007/s10546-025-00945-6). 
...
need to add but should be easy bc afaik Energy is decoupled from momentum?
