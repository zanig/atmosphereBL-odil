...
from sbl_odil.bodil_joint import run_joint_bodil_sampling
...
def main() -> None:
    ...
    parser.add_argument("--n_samples", type=int, default=0, help="no of MCMC samples (0 skips this)")
    ...
    if args.n_samples == 0: 
        ...
        samples, _, _ = run_joint_bodil_sampling(
            data_list,
            forcing_list,
            DEFAULT_WEIGHTS,
            z_list,
            ...
            init_noise=args.init_noise,
            epochs=args.epochs,
            save_path=f"joint_bodil_{args.cases}.npz"
        )
        
        plot_corner(samples, f"{args.cases}", save_path=f"joint_corner_{args.cases}.png")
